...
public class SolParser extends Parser {
	...
	public static final int
		...
		RULE_line = 4, RULE_break = 5, RULE_loop = 6, RULE_if = 7, RULE_block = 8, 
		RULE_labelExpression = 9, RULE_affectation = 10, RULE_instruction = 11, 
		RULE_return = 12, RULE_functionCall = 13, RULE_expression = 14;
	private static String[] makeRuleNames() {
		return new String[] {
			"sol", "declaration", "scope", "function", "line", "break", "loop", "if", 
			"block", "labelExpression", "affectation", "instruction", "return", "functionCall", 
			"expression"
		};
	}
